...
BLOG_AUTHOR = "George T. Silva"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('/posts/about-george-t-silva/', 'About Me', 'fa fa-user'),
        ('https://www.linkedin.com/in/georgesilva1', 'My LinkedIn', 'fab fa-linkedin-in'),
        ('https://econtwitter.net%2F%40georgetsilva', 'My Mastodon', 'fab fa-mastodon'),
...
# is in the manual.
COMMENT_SYSTEM_ID = "data-econoscientist"
